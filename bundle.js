...
},{"./elworado/domhelper":2,"./elworado/elwidget":3,"./elworado/elwire":4,"./elworado/fullscreen":5,"./elworado/httphelper":6,"./elworado/soundPlayer":7,"./splash":10,"moment":9}],2:[function(require,module,exports){
        ...
        if (model != null) {
            if(it.elbind == null)
             { // dont set model on sub elbind (widget)
                var scope = this.scope;
                try {
                    var val = this.evalModel(model,it)
                    if (val == undefined)
                        val = null;
                    // autowire (bidirectional) input                
...
Elbind.prototype.updateModel = function(el,model,value,more)
{
    ...
    var thiselbind = this;
        try {
            ...
            var vals = typeof value === "string" ? ("'"+value+"'") : value;
            eval("scope." + model + "=" + vals);
            if(bidi != null)
            {
                thiselbind.bind();
            }
...
},{"howler":8}],8:[function(require,module,exports){
(function (global){
/*!
 *  howler.js v2.1.1
 *  howlerjs.com
